...
useHead({
  title: "جميع المقالات",
  meta: [{ name: "description", content: "إليك مجموعة من المقالات القيمة" }],
});
</script>
<template>
  <main>
    <header class="page-heading">
      <div class="wrapper">
        <h1 class="text-5xl font-extrabold">جميع المقالات</h1>
        <p class="font-medium text-lg">إليك مجموعة من المقالات القيمة</p>
      </div>
    </header>
    <section class="page-section">
      <Tags />

      <!-- Render list of جميع المقالات in ./content/blog using `path` -->
